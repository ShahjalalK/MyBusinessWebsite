    ...
    <article className="bg-white dark:bg-slate-950">
      ...
      <section className="container mx-auto px-6 pb-12">
        <div className="max-w-5xl mx-auto">
          <div className="relative h-[300px] md:h-[500px] lg:h-[600px] w-full rounded-[0.3rem] md:rounded-[1rem] overflow-hidden shadow-lg">
            {/* Image with improved clarity and no heavy effects */}
            <img 
              src={post.image} 
              alt={post.title} 
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-slate-950/10 to-transparent opacity-40"></div>
          </div>
        </div>
      </section>
    </article>

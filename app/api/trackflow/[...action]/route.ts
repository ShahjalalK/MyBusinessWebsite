...
function buildLeadObject(lead: AnyRecord, existing?: AnyRecord): Record<HeaderName, string> {
  ...
  const generated: Record<HeaderName, string> = {
    ...
    // These must be present because HeaderName includes them, but normal audit/report refreshes
    // should preserve existing Sheet values unless the incoming payload explicitly changes them.
    'Gmail Outreach Stage': getExistingOrDefault(
      existing,
      'Gmail Outreach Stage',
      'ready',
      lead?.gmailOutreachStage || lead?.gmail_outreach_stage || lead?.gmailStage || lead?.gmail_stage,
    ),
    'Gmail Last Sent At': getExistingOrDefault(existing, 'Gmail Last Sent At', '', lead?.gmailLastSentAt || lead?.gmail_last_sent_at),
    'Gmail Next Follow-up Due': getExistingOrDefault(
      existing,
      'Gmail Next Follow-up Due',
      '',
      lead?.gmailNextFollowupDue || lead?.gmail_next_followup_due,
    ),
    ...
    'Gmail Follow-up 1 Sent At': getExistingOrDefault(
      existing,
      'Gmail Follow-up 1 Sent At',
      '',
      lead?.gmailFollowup1SentAt || lead?.gmail_followup_1_sent_at,
    ),
    'Gmail Follow-up 2 Sent At': getExistingOrDefault(
      existing,
      'Gmail Follow-up 2 Sent At',
      '',
      lead?.gmailFollowup2SentAt || lead?.gmail_followup_2_sent_at,
    ),
    'Gmail Follow-up 3 Sent At': getExistingOrDefault(
      existing,
      'Gmail Follow-up 3 Sent At',
      '',
      lead?.gmailFollowup3SentAt || lead?.gmail_followup_3_sent_at,
    ),
    'Gmail Follow-up 4 Sent At': getExistingOrDefault(
      existing,
      'Gmail Follow-up 4 Sent At',
      '',
      lead?.gmailFollowup4SentAt || lead?.gmail_followup_4_sent_at,
    ),
    ...
    'Gmail Follow-up 1 Subject': getExistingOrDefault(
      existing,
      'Gmail Follow-up 1 Subject',
      '',
      lead?.gmailFollowup1Subject || lead?.gmail_followup_1_subject,
    ),
    'Gmail Follow-up 1 Message': getExistingOrDefault(
      existing,
      'Gmail Follow-up 1 Message',
      '',
      lead?.gmailFollowup1Message || lead?.gmail_followup_1_message,
    ),
    'Gmail Follow-up 2 Subject': getExistingOrDefault(
      existing,
      'Gmail Follow-up 2 Subject',
      '',
      lead?.gmailFollowup2Subject || lead?.gmail_followup_2_subject,
    ),
    'Gmail Follow-up 2 Message': getExistingOrDefault(
      existing,
      'Gmail Follow-up 2 Message',
      '',
      lead?.gmailFollowup2Message || lead?.gmail_followup_2_message,
    ),
    'Gmail Follow-up 3 Subject': getExistingOrDefault(
      existing,
      'Gmail Follow-up 3 Subject',
      '',
      lead?.gmailFollowup3Subject || lead?.gmail_followup_3_subject,
    ),
    'Gmail Follow-up 3 Message': getExistingOrDefault(
      existing,
      'Gmail Follow-up 3 Message',
      '',
      lead?.gmailFollowup3Message || lead?.gmail_followup_3_message,
    ),
    'Gmail Follow-up 4 Subject': getExistingOrDefault(
      existing,
      'Gmail Follow-up 4 Subject',
      '',
      lead?.gmailFollowup4Subject || lead?.gmail_followup_4_subject,
    ),
    'Gmail Follow-up 4 Message': getExistingOrDefault(
      existing,
      'Gmail Follow-up 4 Message',
      '',
      lead?.gmailFollowup4Message || lead?.gmail_followup_4_message,
    ),

...
function getManualEvidenceFocusedPageSections(manualEvidenceHero: ManualEvidenceHero | null): {
  ...
  return {
    ...
    auditSnapshotQuestions: [
      `Was ${expectedEvent} clearly seen for ${actionLabel}?`,
      `Why does ${observedEvent} matter for reporting?`,
            ...
            {manualEvidenceHero ? (
              ...
              >
                ...
                <p className="mt-3 max-w-3xl text-sm font-semibold leading-7 text-blue-950/80">
                  The selected action was tested manually. The screenshots below show what was visible during the review. The next step is to match the same action inside GA4, GTM, Google Ads if relevant, and the appropriate lead record.
                </p>
            ...
            {detectedTrackingIdBadges.length ? (
              <div className="mt-4 rounded-[1.15rem] border border-slate-200 bg-white/85 p-4 shadow-sm shadow-slate-950/5 sm:mt-5">
                ...
                <p className="mt-3 text-xs font-semibold leading-6 text-slate-500">
                  These browser-visible IDs show that tracking tools were present during the review. The selected action should still be matched inside the approved tracking tools and the relevant lead records.
                </p>
              </div>
            ) : null}

...
import LinkedInKeywordsPanel from "./LinkedInKeywordsPanel";
...
export default function DashboardPage() {
  ...
  const renderTopTabs = () => {
    const tabs: { id: MainTab; label: string; icon: ReactNode }[] = [
      ...
      { id: "linkedin-keywords", label: "LinkedIn Keyword Generator", icon: <Link2 size={16} /> },
    ...
    <>
      <AdminGuard>
        <div data-no-track="true" data-tfp-dashboard-shell="true" className="min-h-screen max-w-full overflow-x-hidden bg-[#FAFBFF] px-3 pb-4 pt-8 sm:px-4 lg:px-10 lg:pb-10 lg:pt-10">
          ...
          {activeTab === "linkedin-keywords" && <LinkedInKeywordsPanel />}

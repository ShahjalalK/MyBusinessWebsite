...
export type SecureReportRow = {
  ...
  last_reported_active_seconds?: number;
  lastActiveSessionTotalSeconds?: number;
  last_active_session_total_seconds?: number;
  lastActiveReportSessionId?: string;
  last_active_report_session_id?: string;

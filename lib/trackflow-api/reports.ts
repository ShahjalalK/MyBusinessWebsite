...
export function createReportHandlers(deps: ReportHandlerDeps) {
  ...
  function serializeResolvedReport(report: AnyRecord = {}, fallbackToken = ""): AnyRecord {
    ...
    return {
      ...
      openGraphImageUrl: String(report.openGraphImageUrl || report.open_graph_image_url || report.ogImageUrl || report.og_image_url || report.previewImageUrl || report.preview_image_url || ""),
      previewImageUrl: String(report.previewImageUrl || report.preview_image_url || report.ogImageUrl || report.og_image_url || report.homepageScreenshotUrl || report.homepage_screenshot_url || ""),
      homepageScreenshotUrl: String(report.homepageScreenshotUrl || report.homepage_screenshot_url || report.ogImageUrl || report.og_image_url || ""),
      ogImageAlt: String(report.ogImageAlt || report.og_image_alt || ""),
      ogImagePathname: String(report.ogImagePathname || report.og_image_pathname || report.homepageScreenshotPathname || report.homepage_screenshot_pathname || ""),
      homepageScreenshotPathname: String(report.homepageScreenshotPathname || report.homepage_screenshot_pathname || report.ogImagePathname || report.og_image_pathname || ""),
  ...
  async function handleReportRegister(req: Request) {
    ...
    const payload: AnyRecord = {
      ...
      ...(report.ogImageUrl
        ? {
            ...
            open_graph_image_url: report.openGraphImageUrl || report.ogImageUrl,
            previewImageUrl: report.previewImageUrl || report.ogImageUrl,
            preview_image_url: report.previewImageUrl || report.ogImageUrl,
            homepageScreenshotUrl: report.homepageScreenshotUrl || report.ogImageUrl,
            homepage_screenshot_url: report.homepageScreenshotUrl || report.ogImageUrl,
            ogImageAlt: report.ogImageAlt,
            og_image_alt: report.ogImageAlt,
            ogImagePathname: report.ogImagePathname,
            og_image_pathname: report.ogImagePathname,
            homepageScreenshotPathname: report.homepageScreenshotPathname || report.ogImagePathname,
            homepage_screenshot_pathname: report.homepageScreenshotPathname || report.ogImagePathname,
          }
        : {}),
    ...
    return json({
      ...
      domain_slug: report.domainSlug,
      reportUrl: report.reportUrl,
      ogImageUrl: report.ogImageUrl || existingData.ogImageUrl || "",
      openGraphImageUrl: report.openGraphImageUrl || report.ogImageUrl || existingData.openGraphImageUrl || existingData.ogImageUrl || "",
      previewImageUrl: report.previewImageUrl || report.ogImageUrl || existingData.previewImageUrl || existingData.ogImageUrl || "",
      homepageScreenshotUrl: report.homepageScreenshotUrl || report.ogImageUrl || existingData.homepageScreenshotUrl || existingData.ogImageUrl || "",
      ogImagePathname: report.ogImagePathname || existingData.ogImagePathname || "",
      homepageScreenshotPathname: report.homepageScreenshotPathname || report.ogImagePathname || existingData.homepageScreenshotPathname || existingData.ogImagePathname || "",
      pdfFileId: report.pdfFileId,
      pdfViewUrl: report.pdfViewUrl,
      pdfDownloadUrl: report.pdfDownloadUrl,
      blobUrl: report.blobUrl,
